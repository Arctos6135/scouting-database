...
class Strategy extends React.Component {
	...
	if (this.state.event_code) {
	    ...
	    console.log("getting nma" + this.state.event_code, next_match_number, match_type); // We use the paramters instead of the state for match number and type because setState is asynchronous
